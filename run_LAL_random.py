...
for n_labelled in experiment['n_labelleds']:
    ...
    np.savez('./regressionData/LAL-randomtree-simulated2Gauss2dim', all_sizes_data_for_lal, all_sizes_labels_for_lal)
